...
> Who's here? 🔔 — A cross-platform login detection and notification tool.

**whozere** monitors system login events and sends notifications via multiple channels (Webhook, DingTalk, WeCom, Telegram, Slack, Email).
